...
module type Dictionary = sig
  ...
  (** [insert str d] inserts the word [str] in lowercase into a dictionary [d].
      If the dicitonary already contains [str] changes nothing. *)
  ...
  (** [find str d] is [Some lowercase_str] if [str] is bound in [d] regardless
      of character case; or if [str] is not bound, then it is [None].The
      returned string is lowrcase. Returns [true] for the empty string*)
